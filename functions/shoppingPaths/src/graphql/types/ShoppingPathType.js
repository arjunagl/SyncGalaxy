import { GraphQLBoolean, GraphQLObjectType, GraphQLInputObjectType, GraphQLString, GraphQLID, GraphQLList } from 'graphql'
import ShoppingItemType, { ShoppingPathItemInputType } from './ShoppingItemType';
...
const ShoppingPathInputType = new GraphQLInputObjectType({
    name: 'ShoppingPathInput',
    description: 'ShoppingPath Type, For all the shopping paths the user has been involved in.',
    ...
    fields: () => ({
        ...
        shoppingItems: {
            type: new GraphQLList(ShoppingPathItemInputType),
            description: 'Shopping items in this shopping path'
        }
    })
});
